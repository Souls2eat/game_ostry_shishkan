...
class Tower(sprite.Sprite):
        ...
        if self.is_dead != True:
            ...
            if self.name == 'nuka_kusni':
                ...
                if self.hpchela <= 0:
                    ...
                    #        if enemy not in self.toptop_group:
                    #            enemy.hp -= self.taran_atk
                    #            enemy.add(self.toptop_group)
                    #if self.rect.x >= 1700:
                    #    self.kill()
            if self.name != 'nuka_kusni':
                if self.hp <= 0:
    ...
    def update(self):
        ...
        if self.name == 'fire_mag' or self.name == 'kopitel' or self.name == 'thunder' or self.name == 'zeus' or self.name == 'boomchick' or self.name == 'parasitelniy' or self.name == 'spike' or self.name == 'pukish' or self.name == 'drachun' or self.name == 'tolkan' or self.name == 'big_mechman' or self.name == 'nuka_kusni':
            if self.attack_cooldown > 0:
        ...
        for tower in towers_group:
            if tower not in self.buffed_towers:
                if self.rect.collidepoint(tower.rect.centerx, tower.rect.centery):
                    if tower.name == 'fire_mag' or tower.name == 'kopitel' or tower.name == 'thunder' or tower.name == 'yascerica' or tower.name == 'zeus' or tower.name == 'boomchick' or tower.name == 'parasitelniy' or tower.name == 'pukish' or tower.name == 'drachun' or tower.name == 'tolkan' or tower.name == 'big_mechman' or tower.name == 'nuka_kusni':
