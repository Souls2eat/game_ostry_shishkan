...
upgrade_descriptions = {
    ...
    "nizhniy_slizen": {
        "1": "На клетку с ними можно разместить ещё персонажа. Имеет много хп. При смерти накладывает на врагов спереди слизь, которая не даёт им двигаться пока её не убьют",
        "2a": "1 snow_coin",
        "2b": "1 snow_coin",
        "3a": "2 snow_coin",
        "3b": "2 snow_coin",
