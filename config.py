...
upgrade_descriptions = {
    ...
    "gribochek": {
        ...
        "2a": "Союзник во время неуязвимости получает повышение атаки и скорости атаки",  #
        "2b": "Увеличивает длительность неуязвимости. Союзник восстанавливает часть от максимального хп после неуязвимости",  #
        "3a": "Повышение атаки и скорости атаки усиливается(и мб немного сохраняется после конца неуязвимости)",  #
