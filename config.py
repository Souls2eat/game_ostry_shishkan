...
upgrade_descriptions = {
    ...
    "pukish": {
        ...
        "3a": "Ядовитое облако игнорирует защиту врагов и наносит урон сразу по хп. Может пролететь ещё больше врагов",
        "3b": "Ядовитое облако не теряет урон проходя через врагов. Наносимый обычными атаки урон повышается",
    ...
    "boomchick": {
        ...
        "2b": "Каждую вторую атаку из бомбы в разные стороны вылетает четыре осколка",
        "3a": "Усиленная бомба становится основной атакой и кидается постоянно",
        "3b": "Осколков становится шесть и они вызывают небольшой взрыв при столкновении с целью",
    },
    "davalka": {
    ...
    "zeus": {
        ...
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin ... Наносимый урон игнорирует все типы сопротивления врага",
        "3b": "2 city_coin ... Наносимый урон игнорирует все типы сопротивления врага",
    },
    "barrier_mag": {
        ...
        "2a": "Хп барьера увеличивается",
        "2b": "Барьер теперь поглощает не урон, а атаки. Хп барьера заменяется количеством атак которое он может заблокировать.",
        "3a": "Хп барьера увеличивается сильнее. Если барьер сломали, то ближайшие враги получат урон, игнорирующий сопротивления всех типов. При обновлении барьра ближайшие враги получат урон пропорциональный полученномму барьером урону",
        "3b": "Количество атак, которое барьер может поглотить увеличивается. Если барьер сломали, то ближайшие враги получат урон, игнорирующий сопротивления всех типов. При обновлении барьра ближайшие враги получат урон пропорциональный полученномму барьером количеству атак",
    },
    "urag_anus": {
    ...
    "big_mechman": {
        ...
        "2b": "Раз в некоторое время усиливает свой меч, что позволяет ему ударить по увеличенной площади",
        ...
        "3b": "Уменьшает время необходимое для усиления меча. Наносит больше урона если враг находится в зоне, в которой меч не мог его достать до усиления",
    },
    "drachun": {
    ...
    "electric": {
        ...
        "2a": "1 city_coin",
        "2b": "Каждая дальняя атака увеличивает урон следующей ближней атаки. Если совершается больше 5 дальних атак, последующие дальние атаки не будут усиливать ближнюю",
        "3a": "2 city_coin",
        "3b": "Дальние атаки сильнее увеличивают урон ближней",
    },
    "struyniy": {
    ...
    "nekr": {
        ...
        "2a": "Дополнительно выпускает по 1 скелету сверху и снизу некроманта, но в центре на 1 скелета меньше. Повышает скорость движения скелетов",
        "2b": "Скелеты обрастают плотью, превращаясь в зомби с повышенным здоровьем, но немного уменьшенной скоростью движения",
        "3a": "3 скелета превращаются в скелетов с луком и могут наносить урон врагам на расстоянии, но в центре ещё на 1 скелета меньше. Ещё сильнее повышает скорость движения скелетов",
        "3b": "Передний зомби усиливается, ещё больше увеличивая свои здоровье, а также наносит увеличенный урон",
    },
    "electro_maga": {
    ...
    "priest": {
        ...
        "2a": "Первая атака по союзнику после исцеления наносит меньше урона. Эффект уменьшения урона усиливается если союзник на клетке перед свящнником. эффекты уменьшения урона не складываются, при накладывании двух останется только эффект с набольшим значением",
        "2b": "1 city_coin",
        "3a": "Усиливает уменьшение урона от атаки по исцелённому союзнику",
        "3b": "2 city_coin",
    },
    "ded_moroz": {
    ...
    "kot": {
        ...
        "2a": "Время отдыха снижается",
        "2b": "После третьего отдыха начинает царапать врагов",
    ...
    "chistiy": {
        ...
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin ... zeus и barrier_mag также увеличивают количество снарядов за выстрел находясь поблизости, при условии, что они находятся на одном из двух максимальных уровней своей прокачки",
        "3b": "2 city_coin ... zeus и barrier_mag также увеличивают количество снарядов за выстрел находясь поблизости, при условии, что они находятся на одном из двух максимальных уровней своей прокачки",
    },
    "prokach": {
    ...
    "kirka": {
        ...
        "2a": "Если своей атакой сломала броню врагу, то враг оглушится",
        "2b": "Если не дотягивается до врага с бронёй, то может кинуть в него камень, который будет игнорировать врагов без брони",
        "3a": "Длительность оглушения увеличивается",
        "3b": "Камень наносит больше урона",
    },
    "elf": {
    ...
    "sobaka": {
        "1": "На клетку с ним можно разместить ещё персонажа. Увеличивает значение атаки персонажа, находящегося на клетке с собакой",
        "2a": "Когда персонаж на клетке с этой собакой атакует, собака делает дополнительный выстрел, наносящий немного урона",
        "2b": "1 city_coin",
        "3a": "Дополнительный выстрел наносит больше урона",
        "3b": "2 city_coin",
    },
    "chort": {
        "1": "На клетку с ним можно разместить ещё персонажа. Входит в состояние в котором часто атакует на дальнюю дистанцию, после чего какое-то время отдыхает",
        "2a": "1 evil_coin",
        "2b": "1 evil_coin",
        "3a": "2 evil_coin",
        "3b": "2 evil_coin",
    ...
    "smert": {
        "1": "Наносит тем больше урона, чем меньше хп у врага. Если хп врага ниже определённого процента враг мгновенно умрёт при следуещем ударе косой",
        "2a": "Может наносить урон по 3 врагам, но скорость атаки уменьшается",
        "2b": "Увеличивает процент хп при котором враг мгновенно умирает. Немного облегчает получение доп урона зависящего от хп врага",
        "3a": "Возвращает себе нормальную скорость атаки и оставляет возможность наносить урон по 3 врагам",
        "3b": "Ещё сильнее увеличивает процент хп при котором враг мгновенно умирает. Ещё немного облегчает получение доп урона зависящего от хп врага",
    },
    "paladin": {
        "1": "При получении урона лечит союзников вокруг. Если не будет получать урон некоторое время, начнёт себя исцелять",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
    ...
    "vampir": {
        "1": "Кусает врага и лечится на часть от нанесённого врагу урона. На клетку с ним можно разместить ещё персонажа, но тогда он превратится в летучую мышь и его сила уменьшится",
        "2a": "Увеличивает вампиризм и хп в обоих формах",
        "2b": "Теряет возможность атаковать врагов, но взамен в обычной форме наделяет всех персонажей вокруг себя небольшим вампиризмом, а в форме летучей мыши не может быть убит и наделяет персонажа на своей клетке сильным вампиризмом",
        "3a": "Ещё сильнее увеличивает вампиризм и хп в обоих формах",
        "3b": "Увеличивает вампиризм получаемый союзниками вокруг в обычной форме, а также увеличивает вампиризм получаемый союзником в форме летучей мыши",
    },
    "ruchnik": {
        "1": "Используя свои летающие перчатки оттягивает врагов со своей линии на соседнюю",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
    ...
    "grib_strazh": {
        "1": "Выращивает на свободных клетках вокруг себя грибы",
        "2a": "Грибы дают ману при съедании и немного маны при выкапывании",
        "2b": "Хп грибов увеличивается и они получают небольшую регенерацию",
        "3a": "Увеличивается количество выдаваемой грибами маны",
        "3b": "Хп и регенерация грибов усиливаются ещё сильнее",
    },
    "gribochek": {
        "1": "На клетку с ним можно разместить ещё персонажа. Не может быть убит врагами. Если союзник на его клетке получает летальный урон, то он получает временную неуязвимость, а затем остаётся жив с 1 хп, грибочек после этого умирает",
        "2a": "Союзник во время неуязвимости получает повышение атаки",
        "2b": "Увеличивает длительность неуязвимости. Союзник восстанавливает часть от максимального хп после неуязвимости",
        "3a": "Повышение атаки усиливается. Скорость атаки тоже повышается",
        "3b": "Ещё сильнее увеличивает длительность неуязвимости и процент восстанавливаемого хп",
    },
    "bomb": {
...
enemies_descriptions = {
    ...
    "josky": "Жоский челик, помощнее попуска",
    "sigma": "Супер опасный сигма, много хп и сильно кусается",
    "sportik": "Бежит",
    "armorik": "Щитовик",
    "rojatel": "Рожатель",
    "slabiy": "Микрочелик",
    "yatzhik": "Куча",
    "klonik": "Почкователь",
    "teleportik": "Телепортист",
    "fire_res": "Огнечел",
    "ice_res": "Ледочел",
    "water_res": "Водочел",
    "poison_res": "Ядочел",
    "light_res": "Молниячел",
    "zeleniy_strelok": "Стрелок",
    "drobik": "Короткий",
    "telezhnik": "Тележник",
    "mega_strelok": "Мега стрелок"
}
...
en_ru_translate = {
    ...
    "boomchick": "Бумчик",
    "davalka": "Бабка",
    "mana_kamni": "Камни маны",
    "drachun": "Драчун",
    "kopitel": "Копитель",
    "matricayshon": "Скелет роцкер",
    "barrier_mag": "Барьерщик",
    "parasitelniy": "Жук-паразит",
    "pukish": "Пукиш",
    "spike": "Куст",
    "terpila": "Терпила",
    "nizhniy_slizen": "Слизень младший",
    "thunder": "Каменный дед",
    "urag_anus": "Ураганщик",
    "yascerica": "Чел с монстром",
    "super_slizen": "Слизень старший",
    "zeus": "Лазерник",
    "tolkan": "Толкан",
    "big_mechman": "Мегамечник",
    "go_bleen1": "Гоблин",
    "knight_on_horse": "Нука кусни)",
    "gnome_cannon1": "Пушка гномов",
    "electric": "Маг молний",
    "struyniy": "Маг воды",
    "dark_druid": "Тёмный друид",
    "pen": "Затычка",
    "gribnik": "Грибок",
    "bolotnik": "Болотник",
    "nekr": "Некромант",
    "mega_prizivnik": "Демонюк",
    "electro_maga": "Хз кто",
    "inquisitor": "Инквизитор",
    "priest": "Священник",
    "ded_moroz": "Ледяной маг",
    "uvelir": "Ювелир",
    "krovnyak": "Маг крови",
    "kokol": "Трушный друид",
    "sliz": "Слизневод",
    "klonys": "Чеел с клонами",
    "kot": "Кот",
    "furry_druid": "Фурри друид",
    "oruzhik": "Оружейник",
    "kar_mag": "Маг клинков",
    "chistiy": "Лагающий",
    "prokach": "Магический мечник",
    "pulelom": "Пулелом",
    "shabriri": "Безумец",
    "ares": "Контратакер",
    "vozmezdik": "Пулеглот",
    ...
    "kirka": "Шахтёрша",
    "elf": "Эльф",
    "cvetochnica": "Цветочница",
    "holodilnik": "Маг льда и лавы",
    "chorniy": "Маг тьмы",
    "ricar_smerti": "Падший паладин",
    "dushok": "Дух",
    "cepnaya": "Цепная",
    "plut": "Плут",
    "sobaka": "Собака",
    ...
    "molniya": "Молния",
    "tp_back": "Уходите!!!",
    "joltiy_pomidor": "Жёлтый помидор",
    "heal": "Исцеление",
    "zaduv": "Поток воздуха",
    "holod": "Морозная свежесть",
    "popusk": "Попуск",
    "josky": "Жоский",
    "sigma": "Сигма",
    "sportik": "Спортик",
