...
upgrade_descriptions = {
    ...
    "davalka": {
        "1": "Периодически даёт <название валюты>. Жена фаермага(да да не удивляйтесь)",
        "2a": "1 mountain_coin",
        "2b": "1 mountain_coin",
        "3a": "2 mountain_coin",
        "3b": "2 mountain_coin",
    ...
    "kopitel": {
        ...
        "3b": "Копья света могут пробить одного врага, а мечи света наносят в 2 раза больше урона",
    ...
    "spike": {
        "1": "Наносит урон врагам которых касается",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
    ...
    "easy_money": {
        "1": "Мгновенно даёт некоторое количество <название валюты>",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
    ...
    "yascerica": {
        "1": "Кормит своего ненасытного питомца врагами. Геворг летит вперёд и съедает первого попавшегося ему врага, а потом возвращается к хозяину и переваривает пищу. Прокачки скип",
        "2a": "1 evil_coin",
        "2b": "1 evil_coin",
        "3a": "2 evil_coin",
        "3b": "2 evil_coin",
    ...
    "drachun": {
        "1": "Бьёт врагов по морде используя свои любимые кулаки - Геворга и Геворга. прокачки скип",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
    ...
    "gribnik": {
        "1": "Кидает во врага грибы, которые прилипают к врагу. После смерти враг оставляет гриб прочность которого зависит от количества грибов на враге. После своей смерти оставляет грибную поляну",
        "2a": "1 forest_coin",
        "2b": "1 forest_coin",
        "3a": "2 forest_coin",
        "3b": "2 forest_coin",
    ...
    "joltiy_pomidor": {
        "1": "Оглушает врагов в определённой области и за каждого задетого врага даёт <название валюты>",
        "2a": "1 city_coin",
        "2b": "1 city_coin",
        "3a": "2 city_coin",
        "3b": "2 city_coin",
