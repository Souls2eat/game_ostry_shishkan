...
towers_wait = {
    ...
    "greeb1": [image.load(f"images/towers/greeb1/wait/greeb1{i}.png") for i in range(1, 5)],
    "greeb2": [image.load(f"images/towers/greeb2/wait/greeb2{i}.png") for i in range(1, 5)],
    "greeb3": [image.load(f"images/towers/greeb3/wait/greeb3{i}.png") for i in range(1, 5)],
    ...
    "super_slizen": [image.load(f"images/towers/super_slizen/wait/super_slizen{i}.png") for i in range(1, 5)],
    "nizhniy_slizen": [image.load(f"images/towers/nizhniy_slizen/wait/nizhniy_slizen{i}.png") for i in range(1, 5)],
    "cepnaya": [image.load(f"images/towers/cepnaya/wait/cepnaya{i}.png") for i in range(1, 5)],
    "plut": [image.load(f"images/towers/plut/wait/plut{i}.png") for i in range(1, 5)],
    "sobaka": [image.load(f"images/towers/sobaka/wait/sobaka{i}.png") for i in range(1, 5)],
    "chort": [image.load(f"images/towers/chort/wait/chort{i}.png") for i in range(1, 5)],
    "smert": [image.load(f"images/towers/smert/wait/smert{i}.png") for i in range(1, 5)],
    "paladin": [image.load(f"images/towers/paladin/wait/paladin{i}.png") for i in range(1, 5)],
    "vampir": [image.load(f"images/towers/vampir/wait/vampir{i}.png") for i in range(1, 5)],
    "vampir_bat": [image.load(f"images/towers/vampir_bat/wait/vampir_bat{i}.png") for i in range(1, 5)],
    "ruchnik": [image.load(f"images/towers/ruchnik/wait/ruchnik{i}.png") for i in range(1, 5)],
    "grib_strazh": [image.load(f"images/towers/grib_strazh/wait/grib_strazh{i}.png") for i in range(1, 5)],
    "gribochek": [image.load(f"images/towers/gribochek/wait/gribochek{i}.png") for i in range(1, 5)],
...
towers_attack = {
    ...
    "super_slizen": [image.load(f"images/towers/super_slizen/attack/super_slizen{i}.png") for i in range(1, 5)],
    "cepnaya": [image.load(f"images/towers/cepnaya/attack/cepnaya{i}.png") for i in range(1, 5)],
    "plut": [image.load(f"images/towers/plut/attack/plut{i}.png") for i in range(1, 5)],
    "chort": [image.load(f"images/towers/chort/attack/chort{i}.png") for i in range(1, 5)],
    "smert": [image.load(f"images/towers/smert/attack/smert{i}.png") for i in range(1, 5)],
    "vampir": [image.load(f"images/towers/vampir/attack/vampir{i}.png") for i in range(1, 5)],
    "vampir_bat": [image.load(f"images/towers/vampir_bat/attack/vampir_bat{i}.png") for i in range(1, 5)],
...
towers_give = {
    ...
    "grib_strazh": [image.load(f"images/towers/grib_strazh/give/grib_strazh{i}.png") for i in range(1, 5)],
}
...
towers_death = {
    ...
    "greeb1": [image.load(f"images/towers/greeb1/death/greeb1{i}.png") for i in range(1, 5)],
    "greeb2": [image.load(f"images/towers/greeb2/death/greeb2{i}.png") for i in range(1, 5)],
    "greeb3": [image.load(f"images/towers/greeb3/death/greeb3{i}.png") for i in range(1, 5)],
    ...
    "super_slizen": [image.load(f"images/towers/super_slizen/death/super_slizen{i}.png") for i in range(1, 5)],
    "nizhniy_slizen": [image.load(f"images/towers/nizhniy_slizen/death/nizhniy_slizen{i}.png") for i in range(1, 5)],
    "cepnaya": [image.load(f"images/towers/cepnaya/death/cepnaya{i}.png") for i in range(1, 5)],
    "plut": [image.load(f"images/towers/plut/death/plut{i}.png") for i in range(1, 5)],
    "sobaka": [image.load(f"images/towers/sobaka/death/sobaka{i}.png") for i in range(1, 5)],
    "chort": [image.load(f"images/towers/chort/death/chort{i}.png") for i in range(1, 5)],
    "smert": [image.load(f"images/towers/smert/death/smert{i}.png") for i in range(1, 5)],
    "paladin": [image.load(f"images/towers/paladin/death/paladin{i}.png") for i in range(1, 5)],
    "vampir": [image.load(f"images/towers/vampir/death/vampir{i}.png") for i in range(1, 5)],
    "vampir_bat": [image.load(f"images/towers/vampir_bat/death/vampir_bat{i}.png") for i in range(1, 5)],
    "ruchnik": [image.load(f"images/towers/ruchnik/death/ruchnik{i}.png") for i in range(1, 5)],
    "grib_strazh": [image.load(f"images/towers/grib_strazh/death/grib_strazh{i}.png") for i in range(1, 5)],
    "gribochek": [image.load(f"images/towers/gribochek/death/gribochek{i}.png") for i in range(1, 5)],
...
bullets_move = {
    ...
    "big_pike": [image.load(f"images/bullets/big_pike/move/big_pike{i}.png") for i in range(1, 5)],
    ...
    "pubez": [image.load(f"images/bullets/pubez/move/pubez{i}.png") for i in range(1, 5)],
    "big_pubez": [image.load(f"images/bullets/big_pubez/move/big_pubez{i}.png") for i in range(1, 5)],
    "contrsword": [image.load(f"images/bullets/contrsword/move/contrsword{i}.png") for i in range(1, 5)],
...
bullets_death = {
    ...
    "big_pike": [image.load(f"images/bullets/big_pike/death/big_pike{i}.png") for i in range(1, 5)],
    ...
    "pubez": [image.load(f"images/bullets/pubez/death/pubez{i}.png") for i in range(1, 5)],
    "big_pubez": [image.load(f"images/bullets/big_pubez/death/big_pubez{i}.png") for i in range(1, 5)],
    "contrsword": [image.load(f"images/bullets/contrsword/death/contrsword{i}.png") for i in range(1, 5)],
