...
bullets_move = {
    ...
    "electro_maga_sfera": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "emerald": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "explosion": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "fire": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "fireball_big": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "gas": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "grib_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "horse": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "joltiy_explosion": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch1": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch2": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch3": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch4": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch5": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "krov_bul": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "krov_explosion": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "Laser": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "light_big_sword": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "light_spear": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "light_sword": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "mech_vzux": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "mega_strelok_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "mini_kamen": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "nephrite": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "obsidian": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "onyx": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "opal": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "opal_explosion": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "perec_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "pike": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "red_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "ruby": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "sapphire": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "sliz_bul": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "snejok": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "spear_ma": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "stone": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "struya": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "telezhnik_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "tolkan_bux": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "vistrel_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "yellow_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
    "zeleniy_strelok_bullet": [image.load(f"images/bullets/fireball/move/fireball{i}.png") for i in range(1, 5)],
}
...
bullets_death = {
    ...
    "electro_maga_sfera": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "emerald": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "explosion": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "fire": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "fireball_big": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "gas": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "grib_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "horse": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "joltiy_explosion": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch1": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch2": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch3": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch4": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "klonys_punch5": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "krov_bul": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "krov_explosion": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "Laser": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "light_big_sword": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "light_spear": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "light_sword": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "mech_vzux": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "mega_strelok_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "mini_kamen": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "nephrite": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "obsidian": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "onyx": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "opal": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "opal_explosion": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "perec_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "pike": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "red_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "ruby": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "sapphire": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "sliz_bul": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "snejok": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "spear_ma": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "stone": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "struya": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "telezhnik_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "tolkan_bux": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "vistrel_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "yellow_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
    "zeleniy_strelok_bullet": [image.load(f"images/bullets/fireball/death/fireball{i}.png") for i in range(1, 5)],
}
