...
towers_wait = {
    ...
    "kar_voin": [image.load(f"images/towers/kar_voin/wait/kar_voin{i}.png") for i in range(1, 5)],
...
towers_attack = {
    ...
    "kar_voin": [image.load(f"images/towers/kar_voin/attack/kar_voin{i}.png") for i in range(1, 5)],
